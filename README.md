...
Данные (архивы, БД, метрики Prometheus) сохраняются в именованных томах
(`downloads`, `pgdata`, `prometheus-data`) и переживают перезапуск контейнеров.
...
- Хранение файлов — только локальная файловая система (docker volume);
  вынесение в объектное хранилище не реализовано.
